...
def main():
    ...
    env, _, _ = make_env(args.env, args.seed, action_space_type, float(cfg.get("p_stay", 0.8)),
                         bool(cfg.get("no_mpc", False)), bool(cfg.get("no_conformal", False)), safety_params)
    ...
    for ep in range(args.episodes):
        ...
        ep_ret = 0.0; steps = 0; viol = 0; near = 0; shield = 0
